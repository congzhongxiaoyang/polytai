	...
	<div id="top_box">
		...
		<div class="top_bar">
			<p class="adm">
				...
				<span class="adm_people"><?php echo @$name?></span>
			</p>
			<p class="now_time">
				今天是：2013.7.13 
				您的当前位置是：
		...
		<div id="left_box">
			...
			<div class="menu_box">
				...
				<div class="text">
					<ul class="con">
				        <li class="nav_u">
				        	<a href="index.php?r=jingpai/jingpai_add" class="pos">添加竞拍</a>				        	
				        </li> 
				    </ul>
					<ul class="con">
				        <li class="nav_u">
				        	<a href="index.php?r=jingpai/jingpai_list" class="pos">竞拍列表</a>				        	
				        </li> 
				    </ul>
