...
class ShopController extends Controller
{
	...
	public function actionProtype(){
		...
		//热卖商品
		$list=EcsGoods::find()->where("is_hot=1")->orderby("add_time desc")->limit(6)->all();
		//类型
		$fen=EcsCategory::find()->limit(10)->all();
		return $this->renderPartial('proType',['data'=>$info,'comment'=>$comment,'count'=>$cc,'pagination'=>$pagination,'list'=>$list,'fen'=>$fen]);
	}
	//商品详情
