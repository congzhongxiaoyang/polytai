                    ...
                    <div class="sub_right mb30">
                        ...
                        <div class="detail_wrap clearfix">
                            ...
                            <div class="proIntroduce">
                            	<form action="index.php?r=shop/cart" method="post">
                            	<p class="proName"><?php echo $data['goods_name'];
								if($data['is_promote']==1){
								echo '&nbsp;&nbsp;&nbsp;&nbsp;卖家正在促销';
								?></p>
                                <div class="price_wrap clearfix">
                                	<span class="price">￥<?php echo $data['promote_price'];?></span>
                                    <div class="price_msg">
                                    	<p><span class="discount"></span>为您节省￥<?php echo ($data['market_price']-$data['promote_price']);?></p>
                                        <p>(市场价：￥<?php echo $data['market_price'];?>)</p>
                                    </div>
                                    <div class="time_msg">
                                    	<p>02:20:05:17.6</p>
								...
								<input type="hidden" name="shop_price" value="<?php echo $data['promote_price'];?>">
								<?php
								}else{
								?>
								<div class="price_wrap clearfix">
                                	<span class="price">￥<?php echo $data['shop_price'];?></span>
                                    <div class="price_msg">
                                    	<p><span class="discount"></span>为您节省￥<?php echo ($data['market_price']-$data['shop_price']);?></p>
                                        <p>(市场价：￥<?php echo $data['market_price'];?>)</p>
                                    </div>
                                    <div class="time_msg">
                                    	<p>02:20:05:17.6</p>
